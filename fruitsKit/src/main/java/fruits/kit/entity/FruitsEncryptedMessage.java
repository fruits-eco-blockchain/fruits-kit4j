...
public final class FruitsEncryptedMessage {
     ...
     */
    public FruitsEncryptedMessage(byte[] data, byte[] nonce, boolean isText) {
        this.data = data;
        this.nonce = nonce;
        this.isText = isText;
    }
    ...
    public byte[] decrypt(String myPassphrase, byte[] theirPublicKey) {
        return FruitsCrypto.getInstance().decryptMessage(this, myPassphrase, theirPublicKey);
    }
    ...
    public byte[] decrypt(byte[] myPrivateKey, byte[] theirPublicKey) {
        return FruitsCrypto.getInstance().decryptMessage(this, myPrivateKey, theirPublicKey);
    }
